...
#define SMC_RMI_RECLAIM_MERGEABLE_PAGE		SMC_RMI_CALL(0x018F)
#define SMC_RMI_ACK_SET_PAGES_UNMERGEABLE	SMC_RMI_CALL(0x0190)
...
#define RMI_EXIT_UNMERGE_ALLOC 		0x0b
